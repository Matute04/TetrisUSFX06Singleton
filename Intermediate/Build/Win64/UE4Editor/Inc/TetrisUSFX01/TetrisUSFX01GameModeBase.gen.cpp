...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedBoard_MetaData[] = {
		{ "ModuleRelativePath", "TetrisUSFX01GameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedBoard = { "SpawnedBoard", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATetrisUSFX01GameModeBase, SpawnedBoard), Z_Construct_UClass_ABoard_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedBoard_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedBoard_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedBoard,
	};
	...
	IMPLEMENT_CLASS(ATetrisUSFX01GameModeBase, 672624581);
